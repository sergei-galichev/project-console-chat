...
func (c *chatV1Client) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
...
func (UnimplementedChatV1Server) Delete(context.Context, *DeleteRequest) (*DeleteResponse, error) {
